...
const BeveragePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-100 overflow-x-hidden overflow-y-auto">
      {/* Header */}
      <header className="bg-slate-600 text-white p-4 sticky top-0 z-10 shadow-md">
      ...
      <main className="flex-grow p-4 max-w-md mx-auto w-full overflow-x-hidden overflow-y-auto">
            ...
            <div className="flex space-x-2 pb-2 min-w-max">
              <button
                className={`px-4 py-2 rounded-full whitespace-nowrap ${
                  selectedCategory === null ? 'bg-slate-600 text-white' : 'bg-white text-slate-950'
                }`}
              ...
              {categories.map((category) => (
                <button
                  key={category.id}
                  className={`px-4 py-2 rounded-full whitespace-nowrap ${
                    selectedCategory === category.id ? 'bg-slate-600 text-white' : 'bg-white text-slate-950'
                  }`}
        ...
        {/* Beverages Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 overflow-x-hidden overflow-y-auto">
