...
const LanguageSwitcher: React.FC = () => {
  ...
  return (
    <div>
      <button
        className="border-slate-600 bg-gradient-to-r from-slate-900 to-teal-400 border-2 border-r-0 rounded-l-full p-2 cursor-pointer transition-transform duration-150 ease-in-out active:scale-95 text-white
"
